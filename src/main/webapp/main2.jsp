...
<html lang="en">
        ...
        <header class="bg-dark py-3">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    ...
                    <p class="lead fw-normal text-white-50 mb-0">상의</p>
  ...
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="./NewFile1.jsp">추천</a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link" href="#" style="color: #000;">아우터</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#" style="color: #000;">신발</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#" style="color: #000;">모자</a>
  </li>
</ul>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="./NewFile222.jsp">상세 페이지</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item disabled">
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">fit &copy; 핏하네</p></div>
        </footer>
        <!-- Bootstrap core JS-->
